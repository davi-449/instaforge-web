      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          <p className="text-xs text-slate-500 mb-4 bg-blue-50 p-3 rounded-lg border border-blue-100">
            Estas chaves ficam salvas exclusivamente na memória do <b>seu navegador</b> (LocalStorage). Elas não são salvas no nosso banco de dados.
          </p>
          <div>
